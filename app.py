...
def payment(booking_id, method=''):
    ...
    <div style="max-width:720px;margin:0 auto;padding:2.5rem 1.5rem;">
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:.75rem;margin-bottom:1.5rem;">
        <a href="/payment/{bk['id']}/qris" style="padding:1rem;border:2px solid {'rgba(255,215,0,.5)' if method=='qris' else 'rgba(255,255,255,.1)'};border-radius:12px;text-align:center;text-decoration:none;color:#f0f0f8;display:block;"><div style='font-size:1.6rem;margin-bottom:.25rem;'>💰</div><div style='font-size:.8rem;font-weight:600;'>QRIS</div></a>
        <a href="/payment/{bk['id']}/gopay" style="padding:1rem;border:2px solid {'rgba(0,174,214,.5)' if method=='gopay' else 'rgba(255,255,255,.1)'};border-radius:12px;text-align:center;text-decoration:none;color:#f0f0f8;display:block;"><div style='font-size:1.6rem;margin-bottom:.25rem;'>📱</div><div style='font-size:.8rem;font-weight:600;'>GoPay/OVO</div></a>
        <a href="/payment/{bk['id']}/va" style="padding:1rem;border:2px solid {'rgba(59,130,246,.5)' if method=='va' else 'rgba(255,255,255,.1)'};border-radius:12px;text-align:center;text-decoration:none;color:#f0f0f8;display:block;"><div style='font-size:1.6rem;margin-bottom:.25rem;'>🏦</div><div style='font-size:.8rem;font-weight:600;'>Virtual Account</div></a>
        <a href="/payment/{bk['id']}/transfer" style="padding:1rem;border:2px solid {'rgba(52,211,153,.5)' if method=='transfer' else 'rgba(255,255,255,.1)'};border-radius:12px;text-align:center;text-decoration:none;color:#f0f0f8;display:block;"><div style='font-size:1.6rem;margin-bottom:.25rem;'>💳</div><div style='font-size:.8rem;font-weight:600;'>Transfer Bank</div></a>
        <a href="/payment/{bk['id']}/minimarket" style="padding:1rem;border:2px solid {'rgba(249,115,22,.5)' if method=='minimarket' else 'rgba(255,255,255,.1)'};border-radius:12px;text-align:center;text-decoration:none;color:#f0f0f8;display:block;"><div style='font-size:1.6rem;margin-bottom:.25rem;'>🏪</div><div style='font-size:.8rem;font-weight:600;'>Minimarket</div></a>
        <a href="/payment/{bk['id']}/kartu" style="padding:1rem;border:2px solid {'rgba(167,139,250,.5)' if method=='kartu' else 'rgba(255,255,255,.1)'};border-radius:12px;text-align:center;text-decoration:none;color:#f0f0f8;display:block;"><div style='font-size:1.6rem;margin-bottom:.25rem;'>💎</div><div style='font-size:.8rem;font-weight:600;'>Kartu Kredit</div></a>
      </div>
